...
int main(int argc, char *argv[])
{
  ...
  // Assignning Mutexes and Condition Variables

  // //For GetUserInputThread
  // threadSendData.condition = okToSendCondVar;
  // threadSendData.mutex = okToSendMutex;

  // //For sendToThread
  // threadSendToClient.condition = okToSendCondVar;
  // threadSendToClient.mutex = okToSendMutex;

  // //For receiveThread
  // threadReceiveData.condition = okToRecvCondVar;
  // threadReceiveData.mutex = okToRecvMutex;

  // //For outputMessageThread
  // threadDisplayData.condition = okToRecvCondVar;
  // threadDisplayData.mutex = okToRecvMutex;
